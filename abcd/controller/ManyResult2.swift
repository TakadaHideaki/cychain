...
class ManyResult2: UIViewController, UIImagePickerControllerDelegate, MFMailComposeViewControllerDelegate {
...
extension ManyResult2: UITableViewDataSource {
    ...
    extension ManyResult2: UITableViewDelegate {
